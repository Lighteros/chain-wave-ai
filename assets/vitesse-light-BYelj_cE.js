var e = Object.freeze({
  ...
  tokenColors: [
    ...
    },
    {
      ...
      settings: { foreground: "#a65e2b" },
    },
    { scope: ["entity", "entity.name"], settings: { foreground: "#59873a" } },
    {
    ...
    { scope: "entity.name.function", settings: { foreground: "#59873a" } },
    {
      scope: [
        "keyword",
    ...
    },
    {
      ...
      settings: { foreground: "#b56959" },
    },
    {
      scope: ["punctuation.definition.string"],
      settings: { foreground: "#b5695977" },
    },
    {
      scope: ["punctuation.support.type.property-name"],
      settings: { foreground: "#99841877" },
    },
    { scope: "support", settings: { foreground: "#998418" } },
    {
      scope: [
        "property",
        "meta.property-name",
    ...
    },
    {
      ...
      settings: { foreground: "#b07d48" },
    },
    { scope: ["variable", "identifier"], settings: { foreground: "#b07d48" } },
    {
      scope: ["support.type.primitive", "entity.name.type"],
      settings: { foreground: "#2e8f82" },
    },
    { scope: "namespace", settings: { foreground: "#b05a78" } },
    {
      scope: [
        "keyword.operator",
    ...
    { scope: "message.error", settings: { foreground: "#b31d28" } },
    { scope: "string variable", settings: { foreground: "#b56959" } },
    {
      scope: ["source.regexp", "string.regexp"],
      settings: { foreground: "#ab5e3f" },
    },
    {
      scope: [
    ...
    },
    {
      ...
      settings: { foreground: "#bda437" },
    },
    { scope: ["support.constant"], settings: { foreground: "#a65e2b" } },
    {
      scope: [
      ...
      settings: { foreground: "#2f798a" },
    },
    { scope: ["keyword.other.unit"], settings: { foreground: "#ab5959" } },
    {
      scope: ["constant.language.boolean", "constant.language"],
      settings: { foreground: "#1e754f" },
    },
    { scope: "meta.module-reference", settings: { foreground: "#1c6b48" } },
    {
    ...
    },
    {
      ...
      settings: { fontStyle: "bold", foreground: "#1c6b48" },
    },
    { scope: "markup.quote", settings: { foreground: "#2e808f" } },
    {
      scope: "markup.italic",
      settings: { fontStyle: "italic", foreground: "#393a34" },
    },
    {
      scope: "markup.bold",
      settings: { fontStyle: "bold", foreground: "#393a34" },
    },
    { scope: "markup.raw", settings: { foreground: "#1c6b48" } },
    {
      scope: [
        "markup.deleted",
    ...
    { scope: "meta.diff.header", settings: { foreground: "#005cc5" } },
    {
      scope: "meta.separator",
      settings: { fontStyle: "bold", foreground: "#005cc5" },
    },
    { scope: "meta.output", settings: { foreground: "#005cc5" } },
    {
      scope: [
