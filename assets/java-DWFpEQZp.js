  ...
  Object.freeze({
    ...
    repository: {
        ...
        patterns: [
          {
            ...
            patterns: [
              {
                match:
                  "@(author|deprecated|return|see|serial|since|version)\\b",
      ...
      enums: {
        ...
        endCaptures: {
          0: { name: "punctuation.section.enum.end.bracket.curly.java" },
        },
        name: "meta.enum.java",
        patterns: [
          {
          ...
          },
          {
            begin: "{",
            beginCaptures: {
              0: { name: "punctuation.section.enum.begin.bracket.curly.java" },
            },
            end: "(?=})",
            patterns: [
              {
                ...
                patterns: [
                  ...
                  { include: "#comments" },
                  {
                    ...
                    endCaptures: {
                      1: { name: "punctuation.separator.delimiter.java" },
                    },
                    patterns: [
                      { include: "#comments-javadoc" },
                      { include: "#comments" },
                      {
                        begin: "\\(",
                        beginCaptures: {
                          0: { name: "punctuation.bracket.round.java" },
                        },
                        end: "\\)",
                        endCaptures: {
                          0: { name: "punctuation.bracket.round.java" },
                      ...
                      },
                      {
                        begin: "{",
                        beginCaptures: {
                          0: { name: "punctuation.bracket.curly.java" },
                        },
                        end: "}",
                        endCaptures: {
                          0: { name: "punctuation.bracket.curly.java" },
      ...
      module: {
        ...
        endCaptures: {
          0: { name: "punctuation.section.module.end.bracket.curly.java" },
        },
      ...
      numbers: {
        patterns: [
          {
            match:
              "\\b(?<!\\$)0(x|X)((?<!\\.)[0-9a-fA-F]([0-9a-fA-F_]*[0-9a-fA-F])?[Ll]?(?!\\.)|([0-9a-fA-F]([0-9a-fA-F_]*[0-9a-fA-F])?\\.?|([0-9a-fA-F]([0-9a-fA-F_]*[0-9a-fA-F])?)?\\.[0-9a-fA-F]([0-9a-fA-F_]*[0-9a-fA-F])?)[Pp][+-]?\\d([0-9_]*\\d)?[FfDd]?)\\b(?!\\$)",
          ...
          {
            match:
              "(?<!\\$)(\\b\\d([0-9_]*\\d)?\\.\\B(?!\\.)|\\b\\d([0-9_]*\\d)?\\.([Ee][+-]?\\d([0-9_]*\\d)?)[FfDd]?\\b|\\b\\d([0-9_]*\\d)?\\.([Ee][+-]?\\d([0-9_]*\\d)?)?[FfDd]\\b|\\b\\d([0-9_]*\\d)?\\.(\\d([0-9_]*\\d)?)([Ee][+-]?\\d([0-9_]*\\d)?)?[FfDd]?\\b|(?<!\\.)\\B\\.\\d([0-9_]*\\d)?([Ee][+-]?\\d([0-9_]*\\d)?)?[FfDd]?\\b|\\b\\d([0-9_]*\\d)?([Ee][+-]?\\d([0-9_]*\\d)?)[FfDd]?\\b|\\b\\d([0-9_]*\\d)?([Ee][+-]?\\d([0-9_]*\\d)?)?[FfDd]\\b|\\b(0|[1-9]([0-9_]*\\d)?)(?!\\.)[Ll]?\\b)(?!\\$)",
        ...
        patterns: [
          {
            captures: {
              1: { name: "punctuation.separator.period.java" },
              2: { name: "keyword.control.new.java" },
            },
            match: "(\\.)\\s*(new)",
          },
          {
              ...
              { include: "#comments" },
              {
                ...
                patterns: [
                  ...
                  { include: "#storage-modifiers" },
                  {
                    ...
                    endCaptures: {
                      1: { name: "punctuation.catch.separator.java" },
                    },
                    patterns: [
                      { include: "#comments" },
                      {
      ...
      variables: {
        begin:
          "(?=\\b((void|boolean|byte|char|short|int|float|long|double)|(?>(\\w+\\.)*[A-Z_]+\\w*))\\b\\s*(<[\\w<>,\\.?\\s\\[\\]]*>)?\\s*((\\[\\])*)?\\s+[A-Za-z_$][\\w$]*([\\w\\[\\],$][\\w\\[\\],\\s]*)?\\s*(=|:|;))",
        end: "(?=\\=|:|;)",
