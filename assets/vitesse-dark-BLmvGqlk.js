var e = Object.freeze({
  ...
  tokenColors: [
    ...
    { scope: ["entity", "entity.name"], settings: { foreground: "#80a665" } },
    {
      scope: "variable.parameter.function",
      settings: { foreground: "#dbd7caee" },
    },
    {
      scope: ["entity.name.tag", "tag.html"],
      settings: { foreground: "#4d9375" },
    },
    { scope: "entity.name.function", settings: { foreground: "#80a665" } },
    {
      scope: [
        "keyword",
    ...
    },
    {
      ...
      settings: { foreground: "#c98a7d77" },
    },
    {
      scope: ["punctuation.support.type.property-name"],
      settings: { foreground: "#b8a96577" },
    },
    { scope: "support", settings: { foreground: "#b8a965" } },
    {
      scope: [
        "property",
        "meta.property-name",
    ...
    },
    {
      ...
      settings: { foreground: "#bd976a" },
    },
    { scope: ["variable", "identifier"], settings: { foreground: "#bd976a" } },
    {
      scope: ["support.type.primitive", "entity.name.type"],
      settings: { foreground: "#5DA994" },
    },
    { scope: "namespace", settings: { foreground: "#db889a" } },
    {
      scope: [
        "keyword.operator",
    ...
    { scope: "string variable", settings: { foreground: "#c98a7d" } },
    {
      scope: ["source.regexp", "string.regexp"],
      settings: { foreground: "#c4704f" },
    },
    {
      scope: [
    ...
    { scope: ["support.constant"], settings: { foreground: "#c99076" } },
    {
      scope: [
      ...
      settings: { foreground: "#4C9A91" },
    },
    { scope: ["keyword.other.unit"], settings: { foreground: "#cb7676" } },
    {
      scope: ["constant.language.boolean", "constant.language"],
      settings: { foreground: "#4d9375" },
    },
    { scope: "meta.module-reference", settings: { foreground: "#4d9375" } },
    {
    ...
    },
    {
      ...
      settings: { fontStyle: "bold", foreground: "#4d9375" },
    },
    { scope: "markup.quote", settings: { foreground: "#5d99a9" } },
    {
      scope: "markup.italic",
      settings: { fontStyle: "italic", foreground: "#dbd7caee" },
    },
    {
      scope: "markup.bold",
      settings: { fontStyle: "bold", foreground: "#dbd7caee" },
    },
    { scope: "markup.raw", settings: { foreground: "#4d9375" } },
    {
      scope: [
        "markup.deleted",
    ...
    },
    {
      ...
      settings: { background: "#79b8ff", foreground: "#2f363d" },
    },
    {
      scope: "meta.diff.range",
      settings: { fontStyle: "bold", foreground: "#b392f0" },
    },
