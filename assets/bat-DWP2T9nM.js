  ...
  Object.freeze({
    ...
    injections: {
      "L:meta.block.repeat.batchfile": {
        patterns: [{ include: "#repeatParameter" }],
      },
    },
    name: "bat",
    patterns: [
    ...
    repository: {
        ...
        patterns: [
          {
            begin: "(?:^|(&))\\s*(?=((?::[+=,;: ])))",
            beginCaptures: {
              1: { name: "keyword.operator.conditional.batchfile" },
            },
            end: "\\n",
            patterns: [
              {
      ...
      constants: {
        patterns: [
          { match: "\\b(?i:NUL)\\b", name: "constant.language.batchfile" },
        ],
      },
      controls: {
        patterns: [
            ...
            patterns: [
              {
                begin: "(?<=[\\s^])(?i)in(?=\\s)",
                beginCaptures: {
                  0: { name: "keyword.control.repeat.in.batchfile" },
                },
                end: "(?<=[\\s)^])(?i)do(?=\\s)|\\n",
                endCaptures: {
                  0: { name: "keyword.control.repeat.do.batchfile" },
                },
      ...
      repeatParameter: {
        patterns: [
          {
            captures: {
              1: { name: "punctuation.definition.variable.batchfile" },
            },
            ...
            patterns: [
              {
                begin: ":~",
                beginCaptures: {
                  0: { name: "punctuation.separator.batchfile" },
                },
                end: "(?=%|\\n)",
